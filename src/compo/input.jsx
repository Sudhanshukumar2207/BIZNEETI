...
const Input = ({ label, type = "text", inputmode, name, value, onChange }) => {
  ...
  return (
    <div className="relative w-[300px] mb-11 group">
      <input
        ...
        type={type}
        inputMode={inputmode}
        value={value}                   // use parent-controlled value
        onChange={onChange}            // update parent state
        onFocus={() => setFocused(true)}
        onBlur={() => setFocused(false)}
        required
        className="w-full text-[18px] px-[5px] py-[10px] border-b border-gray-500 focus:outline-none bg-transparent peer"
      />
