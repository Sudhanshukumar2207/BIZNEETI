...
export default function Slider() {
  ...
  return (
    <div className="relative overflow-hidden w-screen max-h-150 text-white">
      <div
        ref={sliderRef}
      ...
      <button
        ...
        className="absolute top-1/2 right-4 -translate-y-1/2 text-white opacity-30 hover:opacity-100"
      >
