  ...
  return (
    <div id="contact" className="flex flex-col lg:flex-row justify-center items-center min-h-screen bg-gray-100">
      ...
      <div className="w-[350px] h-[300px] m-8 bg-white lg:w-[500px] lg:h-[400px] rounded-md overflow-hidden shadow-md">
        <iframe
          title="Our Location"
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3597.461997605336!2d85.12455179999999!3d25.622787900000016!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39ed59867e56302d%3A0xf55c5be60d1fe095!2sBizneeti%20services%20Pvt.%20Ltd.!5e0!3m2!1sen!2sin!4v1761930207869!5m2!1sen!2sin"
          width="100%"
          height="100%"
          allowFullScreen=""
          loading="lazy"
